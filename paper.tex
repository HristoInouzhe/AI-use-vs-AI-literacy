...
use: the per-standard-deviation odds ratio of ever having used a non-text
...
link across seven studies: consumers who score lower on objective tests of AI knowledge are, on average, more receptive
...
\begin{enumerate}
  ...
  single index.
  \item Interpretation: the adjusted relationship is weak
  ...
  therefore better interpreted as evidence about non-text AI adoption
...
\begin{figure}[t]
  ...
  \caption{Reported usage frequency by AI tool category (Study~3,
...
\begin{table}[t]
  \centering
  \caption{Pooled five-tool replication of Study~3. Coefficient on a
  ...
  \begin{tabular}{lrrrl}
    ...
    Multinomial logit, item-level        & $-0.189$ to $-0.452$ & NA & $< .05$ all & vs.\ $y=1$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
outcomes. The contrast is clear. For text AI alone, the ordered-logit
...
\begin{table}[t]
  \centering
  \caption{Text vs.\ non-text decomposition. Coefficient on a +1
...
\begin{figure}[t]
  ...
  \caption{AI-literacy effect by tool group and model family.
...
results narrow this prescription in two ways. First, the targeting case
...
\begin{itemize}
  ...
  \item Clustering. Our item-level standard errors do not cluster by
...
read Study~3 as evidence about non-text AI adoption breadth rather
